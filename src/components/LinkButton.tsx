...
export function LinkButton({
  ...
  const className = `inline-flex items-center justify-center gap-2 rounded px-4 py-2 font-mono text-[12px] transition-colors active:translate-y-px ${styles[variant]}${extra ? ` ${extra}` : ""}`;
  if (external) {
    return (
